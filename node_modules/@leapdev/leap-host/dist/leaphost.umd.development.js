(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('uuid'), require('@leapdev/auth-agent/src/index.umd'), require('js-base64')) :
  typeof define === 'function' && define.amd ? define(['exports', 'uuid', '@leapdev/auth-agent/src/index.umd', 'js-base64'], factory) :
  (global = global || self, factory(global.LeapHost = {}, global.uuid, global.index_umd, global.jsBase64));
}(this, (function (exports, uuid, index_umd, jsBase64) { 'use strict';
  ...
  var BaseApi = /*#__PURE__*/function () {
    ...
    _proto.getRefreshedAccessToken = function getRefreshedAccessToken() {
      try {
        ...
        return Promise.resolve(index_umd.AuthAgent.getRefreshedAccessToken());
      } catch (e) {
    ...
    _proto.getUserInfo = function getUserInfo() {
      try {
        return Promise.resolve(index_umd.AuthAgent.userInfo());
      } catch (e) {
        return Promise.reject(e);
      }
    };
  ...
  var BrowserFourdApi = /*#__PURE__*/function (_BaseApi) {
    ...
    _proto.to4DJSONString = function to4DJSONString(value, encode) {
      if (encode === undefined) {
        return 'json=' + jsBase64.Base64.encode(JSON.stringify(value));
      } else {
  ...
  exports.LeapContext = LeapContext;
  exports.LeapHostSdkFactory = LeapHostSdkFactory;

  Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=leaphost.umd.development.js.map
